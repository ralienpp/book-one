...
\includegraphics[width=12cm,height=20cm]{example-image-a}
...
%\vspace{1cm}
\hspace{2cm}\includegraphics[width=8.5cm]{images/general-horseback}
...
\hspace{3cm}\includegraphics[width=6cm]{images/lao-wang}
