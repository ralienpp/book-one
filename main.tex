...
\begin{enumerate}
	...
	\item Скачать \emph{специальную версию книги} \href{https://railean.net/files/book/one-booklet.pdf}{ railean.net/files/book/one-booklet.pdf}.
	\item Открыть файл PDF, выбрать в меню \menu{File > Print} (или нажать \keys{\ctrl + P}).
	\item Задать режим печати с переворотом \emph{по длинному краю} (long edge).
