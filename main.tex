...
% The line below is responsible for drawing debug borders at the edge of the page,
% this is useful if you're preparing the print version
\input{debug-border.tex}

\usepackage{tipa}  % for IPA Mitsumoto
...
\title{\vspace{-60pt}\begin{otherlanguage*}{russian}
...
%\hspace{-10pt}
\vspace{-70pt}
\includegraphics[height=380pt]{images/cat-tree} 
...
\begin{enumerate}
	...
	\item Открыть файл PDF, в меню \menu{File > Print} (или \keys{\ctrl + P}) задать опции:
	\item \emph{Книжная} ориентация (portrait) и переворот \emph{по длинному краю} (long edge).
	\item После печати согнуть %\footnote[2]{Внимание! Вынимая бумагу из принтера, помни, что она может быть горячей! Настоятельно рекомендуется применение митрилловых перчаток!} 
...
\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/camel}}}
\BgThispage
...
% in the section below we use `\caption*` with an asterisk to remove
% subfigure numbers
\begin{figure}[t]
  \begin{subfigure}{.5\paperwidth}
    \centering
    \hspace{-2cm}\includegraphics[width=.8\linewidth]{images/bear-laptop.jpg}
    \caption*{\hspace{-2cm}Сбор телеметрии с сенсоров}
  \end{subfigure}%
  \begin{subfigure}{.5\paperwidth}
    \centering
    \hspace{-2cm}\includegraphics[width=.8\linewidth]{images/fox-ice-core.jpg}
    \caption*{\hspace{-2cm}Экстракция ледяного керна}
  \end{subfigure}
...
\begin{figure}%[h]
  \begin{subfigure}{.5\paperwidth}
    \centering
    \hspace{-2cm}\includegraphics[width=.8\linewidth]{images/orangutan-climber.jpg}
    \caption*{\hspace{-2cm}Ремонт генератора}
  \end{subfigure}%
...
%  \end{subfigure}%
  \begin{subfigure}{.5\paperwidth}
    \centering
    \hspace{-2cm}\includegraphics[width=.8\linewidth]{images/squirrel-solar-panel.jpg}
    \caption*{\hspace{-2cm}Солнечные панели}
  \end{subfigure}
...
\begin{figure}[h]
  \begin{subfigure}{.5\paperwidth}
    \centering
    \hspace{-2cm}\includegraphics[width=.8\linewidth]{images/fox-ranger.jpg}
    \caption*{\hspace{-2cm}Администратор заповедника}
  \end{subfigure}%
  \begin{subfigure}{.5\paperwidth}
    \centering
    \hspace{-2cm}\includegraphics[width=.8\linewidth]{images/ocean-cleanup.jpg}
    \caption*{\hspace{-2cm}Очищение океана}
  \end{subfigure}
...
\begin{verse}[\versewidth]
	Вздулись внезапно вокруг паутины\\
	гул вырастал в австралийской пустыне.\\
	\hspace{-9mm}{\tinyДи}--{\smallджери}--{\large ди--джери}--{\Large ди--джери}--{\LARGEду!}\\
	
    %Вууу--{\largeдууу}--{\Largeбууу}--{\LARGEдууу!}\\
	Всё громче и громче диджериду!\\
	%\say{{\LargeВууу}--{\largeдууу}--буу--{\smallдууууу!}}\\
	\hspace{-11mm}\say{{\LARGE Ди}--{\Largeджери}--{\large ди}--джери--{\small ди}--{\tinyджери--дууууууу}}\\
	Эхом ответила вслед Улур\'{у}.
\end{verse}
\fi
...
% EXPERIMENT: render the text with tikz, such that there's a blurred white oval
% underneath
%\begin{verse}
...
\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/son-broken-leg-end.jpg}}}
\BgThispage
...
\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/parent-kid-kindertrager.pdf}}}
...
% 	\vspace{-70pt}
% 	\hspace{-32pt}
% 	\includegraphics[width=\paperwidth]{images/cyclist-field.jpg}
%   \end{figure}

\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/cyclist-field-full}}}
\BgThispage
...
\newpage
\hfill
\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/redwood-aerial.jpg}}}
\BgThispage
\clearpage


\PlainPoemTitle
\PoemTitle{Красные гиганты~~~~~~~~~~~~~~~~~~~~~~~~}
...
\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/redwood-shifted.jpg}}}
\BgThispage
\newpage

\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/redwood-bottom-up.jpg}}}
\BgThispage
...
\backgroundsetup{scale = 1, angle = 0, opacity = 1, contents = {\includegraphics[width = \paperwidth, height = \paperheight] {images/redwood-hollow.jpg}}}
\BgThispage



\begin{verse}[\versewidth]
	~\\	  % to avoid interference with a leaf in the illustration
...
\item[Гельта] Вид естественных водоёмов на севере Африки, в переводе с арабского это \textquote{лужа} или \textquote{пруд}.
...
\item[Красные гиганты] Sequoia sempervirens и Sequoiadendron giganteum, деревья которые можно найти в зоне побережья Тихого океана в Северной Америке. Могут достичь высоты более 100м, и возраста выше 2000 лет. Встречаются и на других континентах.
\end{description}


% move the annotated star map to the very bottom of the page
\vfill
\vspace{100pt}   % ~3.5cm on A5
