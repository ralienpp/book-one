...
\begin{verse}[\versewidth]
	Глубоко в лесу, вдали от небоскрёбов,\\
	там -- куда дороги не ведут,\\
	там -- где редко люд ногой ступает,\\
	там -- гиганты красные живут.
\end{verse}

\begin{verse}[\versewidth]
	Сотни лет они тянулись к небу,\\
	сотни зим они в метель расли,\\
	их стволы всё время прогибались,\\
	но они держались, не сойдя с пути.
\end{verse}
...
\begin{verse}[\versewidth]
	Эпохи чередуются как волны,\\
	на кольцах записав Земли рассказ,\\
	гиганты помнят всё что было до нас,\\
	и будут помнить всё, что после нас. 
\end{verse}
\begin{verse}[\versewidth]
